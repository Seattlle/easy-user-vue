...
axios.interceptors.response.use(res => {
    NProgress.done();
    const data=res.data;
    const status = Number(data[website.request.statusName||'status']) || 200;
    const statusWhiteList = website.statusWhiteList || [];
    const message = data[website.request.msgName||'msg'] || '未知错误';
...
export const headers=website.RequestHeaders;
